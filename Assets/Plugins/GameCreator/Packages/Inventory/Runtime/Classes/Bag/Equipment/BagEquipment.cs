...
namespace GameCreator.Runtime.Inventory
{
    ...
    public class BagEquipment : IBagEquipment, ISerializationCallbackReceiver
    {
        ...
        protected Dictionary<IdString, List<int>> Equipment { get; private set; }
        ...
        public event Action EventEquip;
        public event Action EventUnequip;
        ...
        public RuntimeItem DetachFrom(RuntimeItem runtimeItem, IdString socketID)
        {
            ...
            if (attachment != null) this.EventChange?.Invoke();
